...
Single-context repo. One `CLAUDE.md` + `docs/` at the root.

## Before exploring, read these

- **`CLAUDE.md`** at the repo root — project invariants, development workflow, common mistakes
- **`docs/functional-map.md`** — complete topology, endpoints, DB schemas, test inventory (960 lines)
