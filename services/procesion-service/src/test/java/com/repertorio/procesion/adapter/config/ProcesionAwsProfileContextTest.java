...
import com.repertorio.procesion.adapter.outbound.messaging.KafkaMessageSender;
import com.repertorio.procesion.adapter.outbound.messaging.SqsMessageSender;
...
@SpringBootTest(classes = {
        ...
        ProcesionAwsProfileContextTest.TestConfig.class
}, webEnvironment = SpringBootTest.WebEnvironment.NONE)
@ActiveProfiles("aws")
class ProcesionAwsProfileContextTest {
